...
public class CollectCommand : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        dragClone.name = "DraggedCollectCommand";
        ...
        Destroy(dragClone.GetComponent<CollectCommand>());
    ...
    public void CreatePermanentClone(Transform slotParent)
    {
        ...
        CollectCommand collectable = permanentClone.GetComponent<CollectCommand>();
        collectable.originalParent = slotParent;
    }
}